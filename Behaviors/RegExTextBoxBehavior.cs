...
namespace Glushkov89.DDPicker
{
    ...
    public class RegExTextBoxBehavior : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty RegularExpressionProperty =
            DependencyProperty.Register("RegularExpression", typeof(string), typeof(RegExTextBoxBehavior), new FrameworkPropertyMetadata(".*"));
        ...
        public static readonly DependencyProperty MaxLengthProperty =
            DependencyProperty.Register("MaxLength", typeof(int), typeof(RegExTextBoxBehavior),
        ...
        public static readonly DependencyProperty EmptyValueProperty =
            DependencyProperty.Register("EmptyValue", typeof(string), typeof(RegExTextBoxBehavior), null);
